...
public class Http2MultiplexCodecTest {
    ...
    public void headerAndDataFramesShouldBeDelivered() {
        ...
        Http2DataFrame dataFrame1 = new DefaultHttp2DataFrame(bb("hello")).setStreamId(streamId);
        Http2DataFrame dataFrame2 = new DefaultHttp2DataFrame(bb("world")).setStreamId(streamId);
