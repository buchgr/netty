...
public class Http2FrameCodecTest {
    ...
    public void entityRequestEntityResponse() throws Exception {
        ...
        inboundHandler.writeOutbound(new DefaultHttp2DataFrame(bb("world"), true, 27).setStreamId(stream.id()));
    ...
    @Test
    public void unknownFrameTypeShouldThrow() throws Exception {
        class UnknownHttp2Frame implements Http2Frame {
            @Override
            public String name() {
                return "UNKNOWN";
            }
        ...
        ChannelFuture f = channel.write(new UnknownHttp2Frame());
        f.await();
        assertTrue(f.isDone());
    ...
    @Test
    public void outgoingStreamActiveShouldNotFireUserEvent() throws Exception {
