...
public class Http2CodecTest {
    ...
    public void multipleOutboundStreams() {
        ...
        assertFalse(isStreamIdValid(((AbstractHttp2StreamChannel<?>) channel1).stream().id()));
        Channel channel2 = b.connect().channel();
        assertTrue(channel2.isActive());
        assertFalse(isStreamIdValid(((AbstractHttp2StreamChannel<?>) channel2).stream().id()));
        ...
        assertTrue(isStreamIdValid(((AbstractHttp2StreamChannel<?>) channel1).stream().id()));
        assertTrue(isStreamIdValid(((AbstractHttp2StreamChannel<?>) channel1).stream().id()));
