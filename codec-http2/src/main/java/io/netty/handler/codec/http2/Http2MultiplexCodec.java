...
public final class Http2MultiplexCodec extends ChannelDuplexHandler {
    ...
    void fireChildReadAndRegister(Http2StreamChannel childChannel, Http2StreamFrame frame) {
    ...
    private void onStreamActive(int streamId) {
        ...
        childChannels.put(streamId, childChannel);
    }
    ...
    private void onStreamClosed0(Http2StreamChannel childChannel) {
        ...
        childChannels.remove(childChannel.streamId);
    }
    ...
    ChannelFuture createStreamChannel(ChannelHandlerContext ctx, int streamId,
